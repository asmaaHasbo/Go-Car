  ...
  List<Map<String, String>> onboardingPagesList = [
    {
      ...
      'animationImg': 'assets/svgs/first_onboarding_button.svg',
    },
    {
      ...
      'description':
          'There are many variations of passages of Lorem Ipsum available, but the majority have suffered but the There are many variations of passages.',
      'animationImg': 'assets/svgs/second_onboarding_button.svg',
    },
    {
      'imagePath': 'assets/images/onboarding_img2.png',
      ...
      'animationImg': 'assets/svgs/third_onboarding _button.svg',
    },
  ];
        ...
        body: Stack(
          children: [
            ...
            Positioned(
              ...
              child: TextButton(
                onPressed: () {
                  context.pushNamed(Routes.login); // Navigate to login screen
                },
                child: Text(
                  'SKIP',
                  style: TextStyle(
...
class OnboardingPageItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Image.asset(imagePath, width: 375.w, height: 301.h, fit: BoxFit.cover),
        Padding(
